...
public class OmnicCoolerPartMachine extends HPCAComponentPartMachine implements IHPCACoolantProvider {
    ...
    public OmnicCoolerPartMachine(IMachineBlockEntity holder, boolean advanced) {
